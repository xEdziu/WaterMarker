...
namespace WaterMarker { 
    ...
    public class CircularProgressBar : Control
    {
        ...
        [Description("Liczba całkowita określająca pozycję paska postępu."), Category("Behavior")]
        public long Value
        {
            get { return _Value; }
            set
        ...
        [Description("Pobiera lub ustawia maksymalną wartość paska postępu."), Category("Behavior")]
        public long Maximum
        {
            get { return _Maximum; }
            set
        ...
        [Description("Szerokość paska postępu."), Category("Appearance")]
        ...
        [Description("Kolor linii pośredniej."), Category("Appearance")]
        ...
        [Description("Szerokość linii pośredniej."), Category("Appearance")]
        ...
        [Description("Pobiera lub ustawia kształt terminali paska postępu."), Category("Appearance")]
        ...
        [Description("Pobiera lub ustawia tryb, gdy tekst jest wyświetlany na pasku postępu."), Category("Behavior")]
        ...
        [Description("Pobiera tekst, który jest wyświetlany w kontrolce."), Category("Behavior")]
